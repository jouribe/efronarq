                ...
                <form method="POST" action="{{ route('projects.update', $project->id) }}" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="flex">
                        <div class="p-4 w-1/2">
                            ...
                            <x-dropdown-list id="currency" name="currency" :items="$currencyList" :selectedId="$project->currency"/>
                    ...
                    <div class="flex">
                        <div class="p-4 w-1/2">
                            ...
                            <x-jet-input type="text" id="account_nro_mn" class="w-full"  name="account_nro_mn" value="{{ $project->account_nro_mn }}"/>
                        ...
                        <div class="p-4 w-1/2">
                            ...
                            <x-jet-input type="text" id="account_nro_me" class="w-full" name="account_nro_me" value="{{ $project->account_nro_me }}"/>
                    ...
                    <div class="flex">
                        <div class="p-4 w-1/2">
                            ...
                            <textarea class="form-textarea editor" id="description" name="description">{{ $project->description }}</textarea>
                        </div>
