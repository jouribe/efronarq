<div class="py-12 top-ventas">
  <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
    ...
    <div class="nav-ventas mx-auto nav-interno">
        <nav class="tabs flex flex-col sm:flex-row">
            ...
            <button data-target="panel-10" class="tab text-gray-600 py-4 px-6 block">
                Fechas
            </button>
        </nav>
    </div>
    <div id="panels">
        <div id="panel-1" class="panel-venta tab-content panel-1 max-w-7xl mx-auto sm:px-6 lg:px-8">
          <h2 class="font-semibold text-xl text-gray-800 leading-tight mb-2 hidden">
              {{ __('Unidades del Proyecto') }}
          </h2>
          <div class="bg-white p-6 rounded-lg shadow mb-10 hidden">
        ...
        <div id="panel-2" class="panel-venta tab-content panel-2 max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div id="panel-3" class="panel-venta tab-content panel-3 max-w-7xl mx-auto sm:px-6 lg:px-8">
          <h2 class="font-semibold text-xl text-gray-800 leading-tight mb-2">
              {{ __('Forma de Pago') }}
          </h2>
          <div class="bg-white p-6 rounded-lg shadow mb-10">
        ...
        <div id="panel-4" class="panel-venta tab-content panel-4 max-w-7xl mx-auto sm:px-6 lg:px-8">
          <h2 class="font-semibold text-xl text-gray-800 leading-tight mb-2">
              {{ __('Convenio Separación') }}
          </h2>
          <div class="bg-white p-6 rounded-lg shadow mb-10">
        ...
        <div id="panel-5" class="panel-venta tab-content panel-5 max-w-7xl mx-auto sm:px-6 lg:px-8">
          <h2 class="font-semibold text-xl text-gray-800 leading-tight mb-2">
              {{ __('Control Documentario') }}
          </h2>
          <div class="bg-white p-6 rounded-lg shadow mb-10">
                          ...
                          @foreach($documentControlData as $item)
                              <div class="flex">
                                  ...
                                  <div class="p-4 w-2/12">
                                      <x-jet-label for="documentControlDate" class="hidden">{{ __('Date') }}</x-jet-label>
                                      <x-jet-input type="date" id="documentControlDate" class="w-full" wire:model="documentControlDate"/>
                                      @error('documentControlDate') <span class="text-red-600 text-xs font-bold">{{ $message }}</span> @enderror
                                  </div>
                                  <div class="p-4 w-4/12">
                                      <x-jet-label for="documentoControlObservation" class="hidden">{{ __('Observation') }}</x-jet-label>
                                      <x-jet-input type="text" id="documentoControlObservation" class="w-full" wire:model="documentoControlObservation"/>
        ...
        <div id="panel-6" class="panel-venta tab-content panel-6 max-w-7xl mx-auto sm:px-6 lg:px-8">
          <h2 class="font-semibold text-xl text-gray-800 leading-tight mb-2">
              {{ __('Minuta') }}
          </h2>
          <div class="bg-white p-6 rounded-lg shadow mb-10">
        ...
        <div id="panel-7" class="panel-venta tab-content panel-7 max-w-7xl mx-auto sm:px-6 lg:px-8">
          <h2 class="font-semibold text-xl text-gray-800 leading-tight mb-2">
              {{ __('Cambios en acabados') }}
          </h2>
          <div class="bg-white p-6 rounded-lg shadow mb-10">
        ...
        <div id="panel-8" class="panel-venta tab-content panel-8 max-w-7xl mx-auto sm:px-6 lg:px-8">
          <h2 class="font-semibold text-xl text-gray-800 leading-tight mb-2">
        ...
        <div id="panel-9" class="panel-venta tab-content panel-9 max-w-7xl mx-auto sm:px-6 lg:px-8">
          <h2 class="font-semibold text-xl text-gray-800 leading-tight mb-2">
              {{ __('Entrega') }}
          </h2>
          <div class="bg-white p-6 rounded-lg shadow mb-10">
        ...
        <div id="panel-10" class="panel-venta tab-content panel-10 max-w-7xl mx-auto sm:px-6 lg:px-8">
          <h2 class="font-semibold text-xl text-gray-800 leading-tight mb-2 hidden">
              {{ __('Fechas') }}
          </h2>
          <div class="bg-white p-6 rounded-lg shadow mb-10 hidden">
