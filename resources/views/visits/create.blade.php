            ...
            <div class="bg-white p-6 rounded-lg shadow">
                ...
                <form method="POST" action="{{ route('visits.store') }}">
                    ...
                    <div class="flex-row">
                        ...
                        <div class="flex">
                            ...
                            <div class="p-4 w-1/3">
                                ...
                                <x-dropdown-list :items="$districts" id="district_id" class="mt-1" name="district_id" :selectedId="old('district_id')" required/>
                            </div>
                        </div>
                        ...
                        <div class="flex">
                            <div class="p-4 w-1/2">
                                ...
                                <x-jet-input class="form-input mt-1 w-full" name="email" id="email" type="email" value="{{ old('email') }}" required/>
                            </div>
                    ...
                    <div class="flex-row p-4 w-1/3">
                        ...
                        <x-dropdown-list :items="$origins" id="origin_id" name="origin_id" class="mt-1" :selectedId="old('origin_id')" required/>
                    </div>
                    ...
                    <div class="flex-row">
                        <div class="flex">
                            <div class="p-4 w-1/5">
                                ...
                                <x-dropdown-list :items="$areaRangeList" id="area_range" name="area_range" class="mt-1" :selectedId="old('area_range')" required/>
                            </div>
                            ...
                            <div class="p-4 w-1/5">
                                ...
                                <x-dropdown-list :items="$financingTypeList" id="type_financing" name="type_financing" class="mt-1" :selectedId="old('type_financing')" required/>
                            </div>
                    ...
                    <livewire:visits.project :projects="$projects" :bool-list="$boolList" :discount-list="$discountList"/>
