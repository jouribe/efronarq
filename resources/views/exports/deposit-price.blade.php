<table cellpadding="0" cellspacing="0" width="100%" style="font-family: Calibri;font-size: 11px;text-align: center;color: #000;" border="0">
    ...
    <tr style="vertical-align: middle;height: 60px;">
        ...
        <th colspan="2" style="font-size: 14px;border: 2px solid #999999;border-left: 0 solid transparent;text-align: right;padding-right: 30px;">Proyecto: Mirador</th>
    </tr>
    <tr>
        <th colspan="4">&nbsp;</th>
    </tr>
    ...
    <tr style="background-color: #dee2e6;vertical-align: middle;height: 20px;">
        <th style="border: 1px solid #999999;border-top: 0 solid transparent;border-left: 2px solid #999999;border-bottom: 2px solid #999999;">PISO</th>
    ...
    @foreach($closets as $closet)
        <tr>
            <td style="border: 1px solid #999999;border-top: 0 solid transparent;">{{ $closet->floor }}</td>
