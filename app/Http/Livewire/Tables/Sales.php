...
class Sales extends LivewireDatatable
{
     ...
     */
    public $searchable = 'pull_aparts.id, projects.name, customers.full_name, pull_aparts.status';
    ...
    public function builder(): Builder
    {
        return PullApart::query()
            ...
            ->onlyForMe()
            ->isASale()
            ->groupBy('pull_aparts.id', 'projects.name', 'customers.full_name', 'project_apartments.name',
    ...
    public function columns(): array
    {
        ...
        return [
            ...
            Column::callback(['pull_aparts.id'], function ($id) {
                return '<a href="' . route('sales.create', ['pullApartId' => $id]) . '" class="inline-block p-1 text-yellow-600 hover:bg-yellow-600 hover:text-white rounded">
